  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden">
        {/* Background Carousel with Reduced Overlay */}
        <HeroCarousel />
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-b from-blue-900/60 via-blue-800/50 to-background z-10"></div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16 relative z-20">
          <div className="max-w-3xl mx-auto text-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl md:text-2xl mb-8 text-white drop-shadow-lg transition-all duration-700 delay-300 ease-in-out backdrop-blur-sm bg-black/30 rounded-lg p-4">
